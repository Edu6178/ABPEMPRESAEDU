...
<head>
    ...
    <title>Nuevo Empleado - Distribuidora ABC</title>
...
<body class="bg-gray-100 font-sans">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10">
            <h1 class="text-3xl font-bold mb-4">Nuevo Empleado</h1>
            ...
            <div class="bg-white rounded-lg p-6 shadow">
                <form action="{{ route('empleados.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4">
                            <label for="nombre_empleado" class="block text-sm font-semibold text-gray-700">Nombre Completo</label>
                            <input type="text" name="nombre_empleado" id="nombre_empleado" class="w-full p-3 mt-1 border border-gray-300 rounded-lg" required>
                        </div>

                        <div class="mb-4">
                            <label for="puesto" class="block text-sm font-semibold text-gray-700">Puesto</label>
                            <input type="text" name="puesto" id="puesto" class="w-full p-3 mt-1 border border-gray-300 rounded-lg" required>
                        </div>

                        <div class="mb-4">
                            <label for="salario" class="block text-sm font-semibold text-gray-700">Salario</label>
                            <input type="number" step="0.01" name="salario" id="salario" class="w-full p-3 mt-1 border border-gray-300 rounded-lg" required>
                        </div>

                        <div class="mb-4">
                            <label for="fecha_contratacion" class="block text-sm font-semibold text-gray-700">Fecha de Contratación</label>
                            <input type="date" name="fecha_contratacion" id="fecha_contratacion" class="w-full p-3 mt-1 border border-gray-300 rounded-lg" required>
                        </div>
                    </div>

                    <div class="mt-4">
                        <button type="submit" class="bg-blue-500 text-white px-6 py-2 rounded-lg">Guardar Empleado</button>
                    </div>
                </form>
            </div>
        </div>
