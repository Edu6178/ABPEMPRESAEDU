...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10">
            ...
            <p class="text-gray-600 mb-6">Explora nuestro catálogo que podemos ofrecer.</p>

            <!-- Grid de productos con imágenes -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div class="bg-white rounded-lg p-4 shadow">
                    <img src="img/p_lapices.jpg" alt="Producto 1" class="w-full h-48 object-cover rounded">
                    <h2 class="text-xl font-semibold text-gray-800 mt-4">Lapices</h2>
                    <p class="text-gray-600">Resistentes y excelente punta (Paquete de 120 piezas).</p>
                    <p class="mt-2 text-lg font-bold text-blue-600">$500 MXN</p>
                </div>

                <div class="bg-white rounded-lg p-4 shadow">
                    <img src="img/p_libreta.jpg" alt="Producto 2" class="w-full h-48 object-cover rounded">
                    <h2 class="text-xl font-semibold text-gray-800 mt-4">Libretas Raya</h2>
                    <p class="text-gray-600">Libretas Marca Scribe de 65 piezas.</p>
                    <p class="mt-2 text-lg font-bold text-green-600">$750 MXN</p>
                </div>

                <div class="bg-white rounded-lg p-4 shadow">
                    <img src="{{ asset('img/PapelMultiusos.jpg') }}" alt="Producto 3" class="w-full h-48 object-cover rounded">
                    <h2 class="text-xl font-semibold text-gray-800 mt-4">Papel Multiusos</h2>
                    <p class="text-gray-600">Paquetes de papeles por separado son 500 unidades (Viene en un sola caja que en total serian 5000 hojas).</p>
                    <p class="mt-2 text-lg font-bold text-yellow-600">$1,200 MXN - $300 MXN</p>
                </div>

                <div class="bg-white rounded-lg p-4 shadow">
                    <img src="{{ asset('img/p_calculadora.jpeg') }}" alt="Producto 4" class="w-full h-48 object-cover rounded">
                    <h2 class="text-xl font-semibold text-gray-800 mt-4">Calculadora Cientifica</h2>
                    <p class="text-gray-600">Calculadora cientifica para ecuaciones mas avanzadas (3 Piezas).</p>
                    <p class="mt-2 text-lg font-bold text-purple-600">$900 MXN</p>
                </div>

                <div class="bg-white rounded-lg p-4 shadow">
                    <img src="{{ asset('img/p_pluma.jpg') }}" alt="Producto 5" class="w-full h-48 object-cover rounded">
                    <h2 class="text-xl font-semibold text-gray-800 mt-4">Boligrafos de Color Rojo Verde Azul y Negro </h2>
                    <p class="text-gray-600">Paquete de Boligrafos (50 piezas por paquete).</p>
                    <p class="mt-2 text-lg font-bold text-red-600">$249 MXN</p>
                </div>
                
<div class="bg-white rounded-lg p-4 shadow">
                    <img src="{{ asset('img/p_tijeras.jpg') }}" alt="Producto 6" class="w-full h-48 object-cover rounded">
                    <h2 class="text-xl font-semibold text-gray-800 mt-4">Tijeras</h2>
                    <p class="text-gray-600">Pack de 6 tijeras MAPED (6 piezas).</p>
                    <p class="mt-2 text-lg font-bold text-teal-600">$519.53 MXN</p>
                </div>
            </div>
</div>
