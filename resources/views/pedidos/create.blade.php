...
<head>
    ...
    <title>Crear Pedido - Distribuidora ABC</title>
...
<body class="bg-gray-100">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="flex-1 p-10">
            <h1 class="text-3xl font-bold mb-4">Nuevo Pedido</h1>
                ...
                <form action="{{ route('pedidos.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombre_cliente" id="nombre_cliente" class="w-full p-3 mt-1 border border-gray-300 rounded-lg" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="total" id="total" class="w-full p-3 mt-1 border border-gray-300 rounded-lg" required>
                        </div>
                    </div>

                    <div class="mt-4">
                        <button type="submit" class="bg-blue-500 text-white px-6 py-2 rounded-lg">Guardar Pedido</button>
                    </div>
                </form>
            </div>
        </div>
